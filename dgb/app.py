...
with st.sidebar:
    ...
    selected = option_menu('DIAGNOBOT', 
...
#     st.title("Welcome to Dignobot")
#     st.header('About Dignobot')
#     st.write("""
#              Welcome to Dignobot, your trusted companion in health diagnostics. 
#     At Dignobot, we are dedicated to leveraging cutting-edge machine 
#     learning technology to revolutionize disease detection and prediction. 
#     Our goal is to provide users with a seamless and reliable platform to 
#     assess their health concerns conveniently and accurately.""")
#     st.header('Our Mission')
#     st.write("""At Dignobot, we are driven by a singular mission: to empower individuals to take control of their 
#     health by offering advanced tools for disease detection and prediction. By harnessing the power 
#     of artificial intelligence and machine learning, we aim to democratize access to reliable health 
#     information, ultimately leading to early detection, proactive prevention, and improved outcomes.""")
#     st.header('What We Offer')
#     st.write('''Dignobot offers a comprehensive suite of disease detection and prediction services, focusing 
#     on four main categories:Dignobot offers a comprehensive suite of disease detection and prediction services, 
#     focusing on these main categories:''')
#     col1,col2,col3 = st.columns(3)
#     with col1:
#         button1=st.button('Acute Diseases Prediction')
#     with col2:
#         button2=st.button('Heart Disease Prediction')
#     with col3:
#         button3=st.button('Diabetes Prediction')
#     with col2:
#         button4=st.button('Breast Cancer Prediction')
...
# if(selected=='Acute Diseases Prediction'):
#         #page title
#         st.title("Acute Diseases Prediction")
